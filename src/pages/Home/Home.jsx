    ...
    <div className="max-w-7xl mx-auto px-6 py-12 font-geist">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
        {[
          ...
          {
            label: "On Track",
            val: friends.filter((f) => f.status === "on-track").length,
          },
          {
            label: "Need Attention",
            val: friends.filter((f) => f.status === "overdue").length,
          },
        ...
        {friends.map((f) => (
          ...
          >
            ...
            <div className="flex flex-col gap-3 w-full items-center">
              ...
              <div
                className={`text-white text-xs font-bold px-6 py-2 rounded-full capitalize shadow-sm ${
                  f.status === "overdue"
                    ? "bg-[#E15549]"
                    : f.status === "almost due"
                      ? "bg-[#F2994A]"
