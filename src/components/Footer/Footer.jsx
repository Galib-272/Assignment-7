// Importing the local assets from your src/assets folder
import facebookIcon from "../../assets/facebook.png";
import instagramIcon from "../../assets/instagram.png";
import xIcon from "../../assets/twitter.png";

const Footer = () => {
  const iconClass = "w-10 h-10 object-contain hover:scale-105 transition-transform cursor-pointer";

  return (
    <footer className="bg-[#244D3F] text-white pt-16 pb-8 px-10 font-geist">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        {/* Requirement 9.1: Footer Brand Logo/Heading */}
        <h2 className="text-5xl font-bold mb-4 tracking-tighter">KeenKeeper</h2>
        
        {/* Requirement 9.3: Figma text color applied directly to ensure accuracy */}
        <p 
          className="max-w-xl mb-8 font-medium text-sm"
        >
        ...
        <div className="flex flex-col items-center gap-4 mb-12">
            <span className="text-xs font-bold tracking-widest text-white-300">Social Links</span>
        ...
        {/* Updated border with white color at low opacity (10%) */}
